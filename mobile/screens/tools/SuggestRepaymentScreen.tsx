...
const styles = StyleSheet.create({
  ...
  tabText: { fontSize: 12, fontWeight: '600', color: 'rgba(255,255,255,0.95)' },
  ...
  budgetLabel: { fontSize: 13, fontWeight: '600', color: Colors.textPrimary },
  budgetAmount: { fontSize: 18, fontWeight: '800', color: Colors.textPrimary },
